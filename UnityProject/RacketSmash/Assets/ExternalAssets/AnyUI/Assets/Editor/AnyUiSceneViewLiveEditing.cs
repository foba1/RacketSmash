    ...
    public class AnyUiSceneViewLiveEditing : Editor
    {
        ...
        private static void createCameraAndRendertextureFor(AnyUiMesh tTarget)
        {
            ...
            if(canvasToProject.worldCamera.targetTexture == null)
            {
                ...
                if (!AssetDatabase.IsValidFolder("Assets/AnyUIRenderTexturesAndMaterials"))
                {
                    AssetDatabase.CreateFolder("Assets", "AnyUIRenderTexturesAndMaterials");
                }
                AssetDatabase.CreateAsset(canvasToTexture, "Assets/AnyUIRenderTexturesAndMaterials/" + canvasToTexture.name + ".renderTexture");
        ...
        public static Material createMaterialInMaterialsList(AnyUiMesh tTarget)
        {
            ...
            if (tTarget.UseMaterial == null)
            {
                ...
                AssetDatabase.CreateAsset(mat, "Assets/AnyUIRenderTexturesAndMaterials/" + mat.name + ".mat");
            }
            else
            {
